...
def read_history():
    ...
    try:
        ...
        result = (
            sheet.values()
            .get(
                spreadsheetId="1gtx4iycix_Bxztaj4M0ZfH3afQPs4iIfdQdwKNNYTyc",
                range=range_name,
            )
            .execute()
        )
...
def input_data(startLocation, endLocation, robot, ai, distance, time, cost):
    ...
    if not (
        isinstance(startLocation, tuple)
        and len(startLocation) == 2
        and isinstance(startLocation[0], int)
        and 1 <= startLocation[0] <= 23041
        and isinstance(startLocation[1], int)
        and 1 <= startLocation[1] <= 46081
    ):
        raise ValueError(
            "startLocation must be of format (int, int) within the valid range"
        )

    if not (
        isinstance(endLocation, tuple)
        and len(endLocation) == 2
        and isinstance(endLocation[0], int)
        and 1 <= endLocation[0] <= 23041
        and isinstance(endLocation[1], int)
        and 1 <= endLocation[1] <= 46081
    ):
        raise ValueError(
...
data = input_data((32, 232), (4323, 232), "robot2", "ai2", 120, 60, 1)
write_history(data)
data = input_data((32, 232), (4323, 232), "robot3", "ai2", 120, 60, 12)
write_history(data)
data = input_data((32, 232), (4323, 232), "robot4", "ai2", 120, 60, 13)
write_history(data)
data = input_data((32, 232), (4323, 232), "robot5", "ai2", 120, 60, 14)
write_history(data)
data = input_data((32, 232), (4323, 232), "robot6", "ai2", 120, 60, 15)
write_history(data)
data = input_data((32, 232), (4323, 232), "robot7", "ai2", 120, 60, 16)
write_history(data)
data = input_data((32, 232), (4323, 232), "robot8", "ai2", 120, 60, 17)
write_history(data)
data = input_data((32, 232), (4323, 232), "robot9", "ai2", 120, 60, 18)
write_history(data)
