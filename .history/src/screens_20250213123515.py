...
class Scroller(tk.Frame):
    def __init__(self, parent, title, items, bg_color, *args, **kwargs):
        ...
        # Title label (using Orbitron for titles)
...
class MetricDisplay(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="Metric Display", font=("Orbitron", 24), bg="#011936")
        label.pack(pady=40)
...
class HistoryScreen(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="History", font=("Orbitron", 24), bg="#011936")
        label.pack(pady=20)
