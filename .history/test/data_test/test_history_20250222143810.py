...
# Optional: if your database.py uses hard-coded file paths,
# you can expose them as module-level variables (e.g., TOKEN_PATH and HISTORY_CSV)
# and override them in tests:
