...
class TestDatabaseFunctional(unittest.TestCase):
    ...
    # Open the file in append mode so that existing data (including the header) isn’t overwritten.
    with open(HISTORY_CSV, "a", newline="") as f:
        writer = csv.writer(f)
        # Convert tuples to string as needed.
    ...
    #     """
    #     data = [(5, 6), (7, 8), "robotY", "aiY", 200, 100, 20]
    ...
    #     # CSV writer converts tuples to their string representation.
    #     expected_row = [str(data[0]), str(data[1]), "robotY", "aiY", "200", "100", "20"]
