...
class TestDatabaseFunctions(unittest.TestCase):
    ...
    def custom_open(file, mode='r', *args, **kwargs):
        # Redirect "data/history.csv" to the temporary history_csv_path
    ...
    with patch("builtins.open", side_effect=custom_open):
        # Now any call to open("data/history.csv", ...) within this block will open your temp file.
    ...
    def setUp(self):
        ...
        self.history_csv_path = "data/history.csv"
